...
type PainPoint = {
  ...
  title: string;
  body: string;
  size: "stacked" | "feature" | "wide";
  area: "a1" | "a2" | "b" | "c1" | "c2" | "d";
  tone: "blue" | "rose" | "amber" | "violet" | "emerald" | "slate";
  visual: "channels" | "clock" | "funnel" | "scatter" | "followup" | "intent";
};

const painPoints: PainPoint[] = [
  { icon: Clock,         eyebrow: "Delayed",      title: "Slow First Response",          body: "High-intent buyers expect fast replies, but sales teams are not always available.",                          size: "stacked", area: "a1", tone: "rose",    visual: "clock" },
  { icon: TrendingDown,  eyebrow: "Leaking",      title: "Weak Traffic Conversion",      body: "Marketing drives traffic, but many visitors leave before becoming qualified enquiries.",                    size: "stacked", area: "a2", tone: "amber",   visual: "funnel" },
